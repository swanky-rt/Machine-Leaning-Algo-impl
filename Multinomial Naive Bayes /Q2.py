...
if __name__ == '__main__':
    ...
    for alpha in alpha_values:
        print(f"Different values of alpha is: {alpha}")
        positive_word_probability = class_probability_with_laplace_soothing(vocab, pos_train, 'positive', alpha)
        negative_word_probability = class_probability_with_laplace_soothing(vocab, neg_train, 'negative', alpha)
    ...
    plot_graph(alpha_values, accuracies)
