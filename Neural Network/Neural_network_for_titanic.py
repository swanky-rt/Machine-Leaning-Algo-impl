...
def plot_learning_curve_titanic(X_train, Y_train, X_test, Y_test, best_layers, best_lambd, learning_rate, step_size=10, epochs=500):
...
def load_titanic_dataset(filepath):
...
if __name__ == "__main__":
    ...
    X, Y = load_titanic_dataset(filepath+filename)
    ...
    # learning curve, this value is for titanic data sets
