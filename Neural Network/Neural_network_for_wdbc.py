...
def plot_learning_curve_wdbc(X_train, Y_train, X_test, Y_test, best_layers, best_lambd, learning_rate, step_size=10, epochs=500):
    ...
    plt.title("Learning Curve (WDBC Dataset)")
    plt.grid(True)
    plt.show()
...
if __name__ == "__main__":
    ...
    X, Y = load_wdbc_dataset(filepath+filename)
    ...
    plot_learning_curve_wdbc(X_train, Y_train, X_test, Y_test, best_layers, best_lambda, learning_rate)